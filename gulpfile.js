...
gulp.task('build', function() {
    runSequence('clean:build', 'sass', 'useref', 'images', 'favicon', 'fonts', 'htmlmin', 'cssnano', 'fontmin');
});
...
gulp.task('cssnano', function() {
    return gulp.src('build/css/master.min.css')
        .pipe(cssnano({
...
gulp.task('fonts', function() {
    return gulp.src('src/fonts/config.json')
        .pipe(fontello())
        .pipe(gulp.dest('build/fonts'))
})

gulp.task('fontmin', function(){
  return gulp.src('build/fonts/css/fontello.css')
      .pipe(cssnano({
            discardComments: {removeAll: true}
        }))
...
gulp.task('sass', function() {
    return gulp.src('./src/stylesheets/sass/master.scss')
